...
title: Open Collaboration for Secure AI Workloads - The Kata Containers and Agent Sandbox Integration
...
The initial release, [available on GitHub now](https://github.com/kubernetes-sigs/agent-sandbox), introduces several capabilities that are already usable in production environments, even as development continues:
...
To learn more, check out [Agent Sandbox](https://agent-sandbox.sigs.k8s.io/), explore the code, and join the conversation on the [Kata Slack](https://join.slack.com/t/katacontainers/shared_invite/zt-16w1u6usn-sK871qbMxVN8KsCP5Gr56A).
